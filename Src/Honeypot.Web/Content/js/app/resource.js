...
var Resource = Observable.extend({
    ...
    getOne: function (id) {
        var self = this;
        Honeypot.Api.get("/Api/Resource/GetOne/" + id, null, function (resp) {
    ...
    get: function (opt) {
        var self = this;
        Honeypot.Api.get("/Api/Resource/Get", opt, function (resp) {
    ...
    update: function (data) {
        var self = this;
        Honeypot.Api.post('/Api/Resource/Update', data, function (resp) {
