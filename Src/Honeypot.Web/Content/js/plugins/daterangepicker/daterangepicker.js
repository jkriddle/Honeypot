/**
*
* MODIFIED VERSION TO WORK WITH MODAL DIALOGS (search for "modal")
*
* @version: 1.0.1
...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        $(window).scroll(function(e) {
            var parentOffset = {
                top: self.parentEl.offset().top, // - this.parentEl.scrollTop(), fixed to function within modal
                left: self.parentEl.offset().left - self.parentEl.scrollLeft()
            };
            if (self.opens == 'left') {
                self.container.css({
                    top: self.element.offset().top + self.element.outerHeight() - parentOffset.top,
                    right: $(window).width() - self.element.offset().left - self.element.outerWidth() - parentOffset.left,
                    left: 'auto'
                });
            } else {
                self.container.css({
    ...
    DateRangePicker.prototype = {
        ...
        move: function () {
            var parentOffset = {
                // @fix - modal
                top: this.parentEl.offset().top, // - this.parentEl.scrollTop(), fixed to function within modal
