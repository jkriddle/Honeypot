/**************************
 * 8/11/12 JKR - THIS HAS BEEN MODIFIED: SEE LINE 106
 ****************************************/
...
(function ($) {
    ...
    var _flatten = function (input, output, prefix, includeNulls) {
        ...
        // Added OR statement too support non-plain objects (i.e. classes).
        // Below is true if the input is an object but not an array (i.e. a function), OR it is just a plain object
        if (($.type(input) == 'object' && !$.isArray(input)) || $.isPlainObject(input)) {
